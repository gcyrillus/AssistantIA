NOT FUNCTIONNAL DO NOT USE - 
# -*- coding: utf-8 -*-
# Données config.json : enregistrées / extraites
# Script           : EIDEN AI
# PROVIDER         : EIDEN AI
# SUB PROVIDER     : {{SUB_PROVIDER_NAME}}
# URL API          : https://api.edenai.run/v2/text/generation
# URL MODELS       : https://api.edenai.run/v2/text/generation/models
# URL REGISTRATION : https://app.edenai.run/
# API KEY          : {{API_KEY}}
...
def demander_code_sur_selection(consigne, code_selectionne, sauvegarder_log=True):
    ...
    try:
        ...
        return _T("MESSAGES", "MSG_PROV_ERR_REQ_CODE").format(provider="{{API_LOCAL_NAME}}", e=str(e))